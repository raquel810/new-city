...
const ALL_IMAGES = Array.from(
  { length: 20 },
  (_, i) => `/projects/schneide-laundry/schneide-laundry-post_photo_${String(i + 1).padStart(3, '0')}-${i + 1}.jpg`
);

const PROJECT_DETAILS = {
  primary: [
    { label: 'Door Style', value: 'Duncan', link: '/door-styles' },
    { label: 'Finish (Laundry Cabinetry)', value: "Benjamin Moore 'Lily Pad'", link: '/finishes' },
    { label: 'Finish (Lockers & Cubbies)', value: "'Polar' Paint with Classic Shiplap Paneling", link: '/finishes' },
    { label: 'Wood Species & Finish (Bench & Drawers)', value: 'Natural Hickory with Custom Stain', link: '/wood-species' },
  ],
  secondary: [
    { label: 'Hardware', value: 'Modern square bar pulls, knobs, and coat hooks in copper' },
    { label: 'Key Features', value: 'Built-in recessed Iron-A-Way wall station, retractable wall-mounted laundry drying racks, and heavy-duty, full-extension custom dovetail bench drawers' },
  ],
};

export default function ProjectSchneideLaundry() {
      ...
      <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-6 md:px-12 pb-12 md:pb-16 max-w-7xl mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white mb-3">
            The Lily Pad Utility Oasis
          </h1>
          <p className="font-sans text-lg md:text-xl text-white/80 max-w-3xl">
            Custom green cabinetry with natural hickory accents in a multi-functional laundry and mudroom
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
        <div className="max-w-3xl">
          <p className="font-sans text-[#242019]/80 text-lg leading-relaxed">
            Organized, intentional, and crafted for effortless daily routines, this multi-functional
            laundry and mudroom pairs custom 'Lily Pad' green cabinetry with warm natural hickory
            accents. Featuring the Duncan door style, the crisp 45-degree chamfered interior edges
            elevate this highly functional space with a refined, tailored aesthetic. Thoughtful
            details — from the integrated shiplap drop zone and glowing copper hardware to hidden
            ironing and drying stations — bring perfect balance to a traditionally chaotic corner
            of the home.
          </p>
        </div>
      </section>
        ...
        <div className="columns-2 md:columns-3 lg:columns-4 gap-3 md:gap-4">
          {ALL_IMAGES.map((src, index) => (
            ...
            >
              <img
                src={src}
                alt={`The Lily Pad Utility Oasis photo ${index + 1}`}
      ...
      {lightboxIndex !== null && (
        <div className="fixed inset-0 z-50 bg-black/95 flex items-center justify-center">
          ...
          <img
            ...
            alt={`The Lily Pad Utility Oasis photo ${lightboxIndex + 1}`}
